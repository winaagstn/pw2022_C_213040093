          ...
          <form action="" method="post">
            <input type="hidden" name="id" value="<?= $mhs["id"]; ?>">
              ...
              <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="npm" name="npm" required style="width: 120px;" value="<?= $mhs["npm"]; ?>" autocomplete="off">
              </div>

              <div class="mb-3">
                  <label for="email" class="form-label">email</label>
                  <input type="email" class="form-control" id="email" name="email" value="<?= $mhs["email"]; ?>" autocomplete="off">
              </div>

              <div class="mb-3">
                  <label for="jurusan" class="form-label">jurusan</label>
                  <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?= $mhs["jurusan"]; ?>" autocomplete="off">
              </div>
