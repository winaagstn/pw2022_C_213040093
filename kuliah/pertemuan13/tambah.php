      ...
      <div class="row mt-3">
          ...
          <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="npm" name="npm" required style="width: 120px;" autocomplete="off">
              </div>
              ...
              <div class="mb-3">
                  ...
                  <img src="" alt="" class="img-thumbnail" id="img-preview" width="120" style="display: none;">
